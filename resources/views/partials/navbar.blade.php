<nav class="absolute top-0 left-0 w-full z-50
	...
	<div class="max-w-7xl mx-auto px-6 py-6 sm:px-6 sm:py-6 lg:px-8 lg:py-5">
		<div class="flex justify-between items-center h-16">
			...
			<div class="hidden md:flex md:items-center md:space-x-8">
				...
				<a href="{{ url('/contact') }}"
					class="text-xl font-medium text-[#e8ded4] hover:text-white transition">Contact Us</a>
				<a href="{{ url('/blogs') }}"
	...
	<div id="mobile-menu" class="md:hidden hidden border-t border-white/20 bg-black/40 backdrop-blur-md">
		<div class="px-4 pt-3 pb-4 space-y-1">
			...
			<a href="{{ url('/contact') }}"
				class="block px-3 py-2 rounded-md text-base font-medium text-[#e8ded4] hover:bg-white/10">Contact Us</a>
			<a href="{{ url('/blogs') }}"
