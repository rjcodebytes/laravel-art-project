...
@section('content')
    <section class="md:p-10 mt-28 md:mt-26 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            @if(!empty($relatedPaintings) && count($relatedPaintings) > 0)
                <div class="mt-16 max-w-7xl mx-auto px-6">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Related Paintings</h2>

                    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @foreach ($relatedPaintings as $rp)
                            <a href="{{ route('collection.show', $rp->slug) }}"
                                ...
                                <div class="w-full h-56 bg-gray-100 rounded-t-lg overflow-hidden">
                                    @if(isset($rp->images[0]))
                                        <img src="{{ asset('storage/' . $rp->images[0]) }}"
