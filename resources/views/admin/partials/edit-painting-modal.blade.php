<!-- Edit Painting Modal -->
<div id="editPaintingModalWrapper" x-data="{ open: false }" x-cloak x-show="open" @open-edit-modal.window="open = true"
    ...
    <div x-show="open" x-transition:enter="transition transform ease-out duration-300"
        ...
        x-transition:leave-end="opacity-0 scale-95" @click.away="open = false" @keydown.escape.window="open = false"
            ...
            <div class="space-y-4 overflow-y-auto hide-scrollbar pr-3" style="max-height:60vh;">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="edit_art_type" name="art_type"
                ...
                <div>
                    ...
                    <input type="file" id="edit_images" name="images[]" multiple
                        class="w-full border rounded-lg px-3 py-2">
                    <div id="newImagePreview" class="flex flex-wrap gap-3 mt-2"></div>
                </div>
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Related Paintings</label>

                    <select id="edit_related_paintings" name="related_paintings[]" multiple
                        class="w-full p-2 border rounded-lg">
                    </select>

                    <!-- Selected chips -->
                    <div id="related_chips" class="flex flex-wrap gap-2 mt-3"></div>

                    <p class="text-xs text-gray-500 mt-1">Click on a chip to remove a painting.</p>
                </div>
